...
class BagProcess(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(PozyxRangeArray, "pozyx/ranges", self.pozyx_cb, 100)
    ...
    def pozyx_cb(self, msg):
        self.range_times.append(msg.header.stamp.sec + msg.header.stamp.nanosec / 1e9)
    ...
    def on_shutdown(self):
        ...
        range_data_file = os.path.join(save_location, f"{self.veh_ns}_range_data.csv")
