...
def generate_launch_description():
    ...
    long_controller_la = DeclareLaunchArgument(
        ...
        choices=['bicycle_mpc', 'constant_input', 'double_int_mpc', 
                 'l1_pfmpc', 'quad_pfmpc', 'linear_mpc', 'track_vl']
    )
    ...
    vl_sim_node = Node(
        ...
        condition=IfCondition(PythonExpression([
            "('", long_controller, "' == 'quad_pfmpc' or '", 
            long_controller, "' == 'l1_pfmpc' or '",
            long_controller, "' == 'linear_mpc' or '",
            long_controller, "' == 'track_vl') and '",
            use_sim, "' == 'true'"
        ]))
    )
    ...
    constant_input_sim_node = Node(
        ...
        parameters=[convoy_sim_config, {'veh_ns': veh_ns}],
        condition=IfCondition(PythonExpression([
            "'", long_controller, "' == 'constant_input' and '", 
            use_sim, "' == 'true'"
        ])),
        output='screen'
    )
    ...
    linear_mpc_sim_node = Node(
        ...
        parameters=[convoy_sim_config, 
                    {'veh_ns': veh_ns, 'use_sim': use_sim}],
        condition=IfCondition(PythonExpression([
            "'", long_controller, "' == 'linear_mpc' and '", 
            use_sim, "' == 'true'"
        ])),
        output='screen'
    )
    ...
    bicycle_mpc_sim_node = Node(
        ...
        condition=IfCondition(PythonExpression([
            "'", long_controller, "' == 'bicycle_mpc' and '", 
            lat_controller, "' == 'bicycle_mpc' and '", 
            use_sim, "' == 'true'"
        ])),
        output='screen'
    )
    ...
    double_int_mpc_sim_node = Node(
        ...
        condition=IfCondition(PythonExpression([
            "'", long_controller, "' == 'double_int_mpc' and '", 
            use_sim, "' == 'true'"
        ])),
        output='screen'
    )
