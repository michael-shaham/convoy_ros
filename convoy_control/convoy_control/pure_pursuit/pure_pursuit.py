...
class PurePursuit:
    ...
    def __init__(self,
        ...
        if const_l_d:
            ...
            self.l_d = self.compute_lookahead_distance(
                l_d_speed_gain, min_l_d, max_l_d
            )
        else:
    ...
    def get_intersection_point(self):
        ...
        for i in range(self.c_i, self.waypoints.shape[0] - 1):
            ...
            if dist_current  < self.l_d and dist_next  > self.l_d:
                ...
                target_point = ratio * self.waypoints[i] + \
                               (1 - ratio) * self.waypoints[i+1]
    ...
    def get_actuation(self, target_point):
        ...
        """
        alpha = np.arctan2(target_point[1] - self.veh_pos[1],
                           target_point[0] - self.veh_pos[0])
