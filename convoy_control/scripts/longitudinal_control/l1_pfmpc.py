...
class L1PFMPCNode(Node):
    ...
    def __init__(self):
        ...
        q_self_l1 = (
            self.declare_parameter("q_self_l1").get_parameter_value().double_value
        )
        q_pred_l1 = (
            self.declare_parameter("q_pred_l1").get_parameter_value().double_value
        )
        r_l1 = self.declare_parameter("r_l1").get_parameter_value().double_value
        w = self.declare_parameter("W_l1").get_parameter_value().double_array_value
        W = np.diag(w)
