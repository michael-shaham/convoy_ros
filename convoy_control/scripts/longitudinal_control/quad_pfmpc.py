...
class QuadPFMPCNode(Node):
    ...
    def __init__(self):
        ...
        q_pos = self.declare_parameter(
            'q_self_quad_position').get_parameter_value().double_value
        q_speed = self.declare_parameter(
            'q_self_quad_speed').get_parameter_value().double_value
        q_pred_pos = self.declare_parameter(
            'q_pred_quad_position').get_parameter_value().double_value
        q_pred_speed = self.declare_parameter(
            'q_pred_quad_speed').get_parameter_value().double_value
        r = self.declare_parameter(
            'r_quad').get_parameter_value().double_value
        ...
        if self.use_sim:
            self.pfmpc = SparseQuadPFMPC(Q, Q_p, R, self.dyn.A, self.dyn.B, 
                                         self.dyn.C, a_min, a_max, self.H)
        else:
            self.pfmpc = SparseQuadPFMPCVel(Q, Q_p, R, self.dyn.A, self.dyn.B, 
