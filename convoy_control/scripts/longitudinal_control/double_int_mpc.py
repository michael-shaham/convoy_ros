...
class DoubleIntMPCNode(Node):
    ...
    def __init__(self):
        ...
        self.Q = self.declare_parameter('Q_double_int_weight').get_parameter_value().double_value
        self.R = self.declare_parameter('R_double_int_weight').get_parameter_value().double_value
    ...
    def traj_cb(self, msg):
        ...
        if prob.status != 'optimal':
            self.get_logger().info(f"double integrator mpc returned " +
                                   f"{prob.status}")
