...
class PreprocessLidar(Node):
    ...
    def __init__(self):
        ...
        self.fov_rad = self.get_parameter("fov_deg").value * np.pi / 180.
        self.min_angle = -self.fov_rad / 2.
        self.max_angle = self.fov_rad / 2.
    ...
    def scan_cb(self, msg: LaserScan):
        ...
        if np.isclose(fov_og, self.fov_rad, rtol=0., atol=1e-2):
