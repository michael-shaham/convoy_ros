...
def generate_launch_description():
    ...
    rplidar_include_with_ns = GroupAction(actions=[
        PushRosNamespace(veh_ns), rplidar_include
    ])
    ...
    static_base_lidar_tf_node = Node(
        ...
        namespace=veh_ns,
        arguments=['0.27', '0.0', '0.11', '0.0', '0.0', '0.0', 
                   'base_link', 'laser'],
